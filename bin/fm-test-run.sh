...
family_for_basename() {
  case "$1" in
    ...
    fm-pr-create-pretool-check.test.sh|fm-composer-ghost.test.sh|fm-composer-lib.test.sh|\
    fm-crew-state.test.sh|fm-decision-hold-lifecycle.test.sh|\
    fm-documentation-audiences.test.sh|fm-ensure-agents-md.test.sh|fm-grok-harness.test.sh|\
    fm-kimi-harness.test.sh|fm-herdr-lab.test.sh|fm-lint.test.sh|\
    fm-operational-input.test.sh|fm-pi-primary-types.test.sh|\
    fm-procevent-mission-control.test.sh|\
    ...
    fm-test-run.test.sh|fm-test-isolation-proof.test.sh)
      printf '%s\n' pure-contract-unit
      ;;
    fm-captain-commitment.test.sh|fm-daemon.test.sh|fm-guard-stale-banner.test.sh|\
    fm-grok-stop-autoarm.test.sh|fm-pi-watch-extension.test.sh|\
    ...
    fm-herdr-session-cleanup-e2e.test.sh|fm-secondmate-restart-herdr-e2e.test.sh|\
    ...
    fm-secondmate-liveness.test.sh|fm-secondmate-restart.test.sh|\
    ...
    fm-grok-stop-autoarm-live-e2e.test.sh|fm-grok-stop-live-e2e.test.sh|\
    fm-harness-liveness-drift-live-e2e.test.sh|\
    fm-watch-footer-drift-live-e2e.test.sh|\
    fm-opencode-primary-live-e2e.test.sh|fm-pi-primary-live-e2e.test.sh|\
    fm-quota-array-dispatch-live-e2e.test.sh|fm-send-secondmate-marker-herdr-e2e.test.sh|\
    fm-treehouse-pool-lease-live-e2e.test.sh)
      printf '%s\n' live-harness-optin
      ;;
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-gate-refuse*|bin/fm-lock*|bin/fm-quota-axi-lib.sh)
      printf '%s\n' session-bootstrap
      ;;
    bin/fm-pr-create-*|bin/fm-pr-target-config.sh)
      printf '%s\n' pure-contract-unit
      ;;
    ...
    .claude/settings.json|.codex/hooks.json|.grok/hooks/*|.opencode/plugins/*|\
    .pi/extensions/fm-primary-turnend-guard.ts|docs/configuration.md|\
    docs/documentation-audiences.json|docs/pr-target-guard.md|docs/supervision-protocols/*)
      printf '%s\n' pure-contract-unit
      ;;
