...
Empty or no-op supervision wakes stay captain-silent; never send a stock acknowledgement for watcher completions, empty wake drains, elapsed waits, or other non-events.
