...
# A fake tmux that reports FM_FAKE_PANE_PATH as the pane cwd after the spawn
# sends it into the leased copy
...
#   - the worktree-entry send-keys and the worktree wait loop target that stable
