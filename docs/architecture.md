...
A ready verdict is therefore demoted whenever the worktree holds unlanded tracked edits, to working when the crew is busy and to unknown when it is not, because only the second of those stays absorb-ineligible for a crew that wedged with unlanded work.
