...
3. For each choice, choose a stable key and use the script's `hold` command with a concise title, reason, and repository, plus every context dimension the filing bar above requires.
